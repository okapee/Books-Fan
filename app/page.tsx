...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-b from-blue-50/30 via-purple-50/20 to-white py-24 md:py-32">
      ...
      <section
        id="features"
        className="relative bg-gradient-to-br from-blue-50/50 via-white to-purple-50/30 py-24 overflow-hidden"
      >
        {/* Background Pattern */}
      ...
      <section
        id="all-features"
        className="bg-gradient-to-br from-purple-100 via-purple-50 to-blue-50 py-24"
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
      ...
      {/* CTA Section */}
      <section className="relative bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-600 py-24 overflow-hidden animate-gradient">
        {/* Floating elements */}
